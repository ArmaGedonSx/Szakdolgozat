...
namespace Chat_Server
{
    public static class Database
    {
        ...
        {
            UsersFilePath = UsersFolderPath + @"/Users.txt";
            UsersFilePath_backup = UsersFolderPath + @"/Users (backup).txt";
            ServersFilePath = ServersFolderPath + @"/Servers.txt";
            ServersFilePath_backup = ServersFolderPath + @"/Servers (backup).txt";
        ...
        public static bool DisconnectFromServer(string login, string sid, IPEndPoint end)
        {
            if (Servers.TryGetValue(sid, out Server server))
            {
                return server.Disconnect(GetUser(login), end);
            }
            return false;
        }
